...
outdir = pathlib.Path('cache/categorize_chemicals')

# Set up logging
os.makedirs('cache/categorize_chemicals', exist_ok=True)
logging.basicConfig(filename='cache/categorize_chemicals/log.txt', level=logging.INFO, filemode='w')
...
# Read the CSV file
df = pd.read_csv('cache/parse_chemicals/chemicals.csv')
